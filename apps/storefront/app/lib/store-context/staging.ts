...
const staging: Environment = {
    contexts: [
        {
            label: 'Asia Pacific (STG)',
            code: 'INTL',
            routePrefix: null,
            language: 'en-au',
            shopifyDomain: 'maaptest.myshopify.com',
        ...
        },
        {
            ...
            routePrefix: 'us',
            language: 'en-us',
            shopifyDomain: 'usa-staging-maap.myshopify.com',
        ...
        },
        {
            ...
            routePrefix: 'eu',
            language: 'en-eu',
            shopifyDomain: 'maap-eu-staging.myshopify.com',
        ...
        {
            label: 'United Kingdom (STG)',
            code: 'UK',
            routePrefix: 'uk',
            language: 'en-uk',
            shopifyDomain: 'uk-staging-maap.myshopify.com',
