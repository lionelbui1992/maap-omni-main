...
const MonumentVimeoVideoItem = ({ block, items }) => {
    const {
        layout,
        heading,
        body_text,
    ...
    const videoSize = fill_entire_row ? 'vimeoVideoFull' : 'vimeoVideoHalf';
    ...
    return (
        <>
            <div
                className={`monumentVimeoVideo_element ${variantOrderType(
                    variant_type
                )}`}
            >
...
const MonumentVimeoVideo = ({ block, items }) => {
...
MonumentVimeoVideo.propTypes = {
    block: PropTypes.object,
};

MonumentVimeoVideoItem.propTypes = {
    block: PropTypes.object.isRequired,
};

export default MonumentVimeoVideo;
