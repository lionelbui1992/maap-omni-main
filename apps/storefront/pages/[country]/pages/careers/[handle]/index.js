...
export async function getStaticProps({ params, preview = false, previewData }) {
    ...
    const { language } = getContext(country);

    const cmsProps = await getCmsProps(shopContext, language, handle);

    return {
        props: {
            shopContext,
            regionCode: shopContext.code,
            localeCode: shopContext.language,
            preview,
            ...cmsProps,
        },
        revalidate: 900,
